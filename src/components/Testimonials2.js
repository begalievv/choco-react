...
const Testimonials = () => {
    ...
    const testimonialImages = [
        {
            id: 1,
            image: 'images/ourworks/1.jpg',
            alt: 'Шоколадная работа 1'
        },
        {
            id: 2,
            image: 'images/ourworks/2.jpg',
            alt: 'Шоколадная работа 2'
        },
        {
            id: 3,
            image: 'images/ourworks/3.jpg',
            alt: 'Шоколадная работа 3'
        },
        {
            id: 4,
            image: 'images/ourworks/4.jpg',
            alt: 'Шоколадная работа 4'
        },
        {
            id: 5,
            image: 'images/ourworks/5.jpg',
            alt: 'Шоколадная работа 5'
        },
        {
            id: 6,
            image: 'images/ourworks/6.jpg',
            alt: 'Шоколадная работа 6'
        },
        {
            id: 7,
            image: 'images/ourworks/7.jpg',
            alt: 'Шоколадная работа 7'
        },
        {
            id: 8,
            image: 'images/ourworks/8.jpg',
            alt: 'Шоколадная работа 8'
        },
        {
            id: 9,
            image: 'images/ourworks/9.jpg',
            alt: 'Шоколадная работа 9'
        },
        {
            id: 10,
            image: 'images/ourworks/10.jpg',
            alt: 'Шоколадная работа 10'
        }
    ];
